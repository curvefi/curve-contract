...
def test_remove_liquidity(bob, swap, underlying_coins, wrapped_coins, pool_token, min_amount, initial_amounts, base_amount, n_coins):
...
def test_remove_partial(bob, swap, underlying_coins, wrapped_coins, pool_token, initial_amounts, base_amount, n_coins):
